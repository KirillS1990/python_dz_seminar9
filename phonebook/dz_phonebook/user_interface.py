...
def ls_menu():
    while True:
        ...
        print('8. Экспортировать телефонную книгу в файл ".txt".')
        print('9. Импортировать телефонную книгу из файла ".txt".')
        ...
        if n == 1:
            ...
            cr.write_file_txt()
            print('Контакты выгружены в "base_phone.txt"')
            print('Контакты в формате ".csv" уже имеются в папке')
